...
class packet:
    ...
    def __init__(self, sequence_number, stream_id, payload, state=constants.WAITING):
        ...
        self.payload_size = len(payload)  # I -> 4 bytes
        self.checksum = self.calculate_checksum()  # s -> 16 bytes
    ...
    def pack_ack(seq):
        checksum = utils.calculate_checksum(bytes(str(seq), 'utf8'))
